...
const App = () => {
  ...
  const hasFunction = (code, language) => {
    const patterns = {
      python: /^\s*def\s+\w+\s*\(.*\)\s*:/m,
      javascript: /(function\s+\w+\s*\(.*\)|\w+\s*=\s*\(.*\)\s*=>)/m,
      java: /(public|private|protected)?\s+\w+[\w<>\[\]]*\s+\w+\s*\(.*\)\s*\{/m,
      c: /\b[a-zA-Z_][a-zA-Z0-9_<>]*\s*\*?\s+[a-zA-Z_][a-zA-Z0-9_]*\s*\([^)]*\)\s*\{/m
    };
  ...
  const optimizeCode = async () => {
    ...
    // Check for valid function definition
  if (!hasFunction(userCode, programmingLanguage)) {
    setError(
      `No valid function definition found for ${programmingLanguage}. Please provide a complete function.`
    );
    return;
  }
    ...
    try {
      ...
      setError(
        "An error occurred while optimizing the code. Please try again."
      );
      console.error(err);
    } finally {
      setIsLoading(false);
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <header style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <p style={{ color: "#000000" }}>
            Submit your code and get optimized versions with performance
            analysis
          </p>
        </header>
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              <button
                ...
                style={{
                  ...
                  border: "none",
                  cursor:
                    isLoading || !userCode.trim() ? "not-allowed" : "pointer",
                  fontSize: "14px",
                  fontWeight: "500",
              ...
              <div>
                ...
                <div
                  style={{
                    ...
                    gap: "8px",
                    backgroundColor:
                      result.status === true ? "#f0fdf4" : "#fef2f2",
        ...
        {/* Testing Section - Only show if optimization is successful and language is python*/}
        {result && result.status === true && programmingLanguage == "Python" && (
          <div
            style={{
              marginTop: "24px",
              background: "white",
          ...
          >
            ...
            >
              Enter function arguments as an array in this format. Example:
              [first argument, second argument] for two arguments
            </p>
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                cursor:
                  isTestingLoading || !testInputs.trim()
                    ? "not-allowed"
                    : "pointer",
                fontSize: "14px",
                fontWeight: "500",
              ...
              <div>
                ...
                <div
                  style={{
                    ...
                    alignItems: "center",
                    gap: "8px",
                    backgroundColor: testResults.outputsMatch
                      ? "#f0fdf4"
                      : "#fef2f2",
                    ...
                    borderRadius: "8px",
                    marginBottom: "16px",
                    border: testResults.outputsMatch
                      ? "2px solid #10b981"
                      : "2px solid #ef4444",
                  }}
                >
